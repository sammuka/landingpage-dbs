...
export const metadata: Metadata = {
  ...
  description:
    "De um monolito Java EE com 48 dívidas técnicas e 9 CVEs críticos para arquitetura cloud-native .NET 9 / Azure Container Apps com 163 testes e zero vulnerabilidades críticas.",
  keywords: [
    "Assurant DBS",

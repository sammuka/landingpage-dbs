...
export const timelinePhases: TimelinePhase[] = [
  {
    ...
    number: "01",
    title: "Diagnóstico",
    period: "31 Mar – 02 Abr 2026",
    color: "#dc2626",
    colorDark: "#f87171",
    details: [
      "Análise de 906 classes Java em 7 módulos Eclipse",
      "Mapeamento de 42 dívidas técnicas e 9 CVEs críticos",
      "Auditoria de dependências EOL (Struts 1.3, CXF 2.7.17)",
      "Avaliação de 0% cobertura de testes",
    ],
    deliverables: [
      "16 documentos AS-IS (docs/as-is/)",

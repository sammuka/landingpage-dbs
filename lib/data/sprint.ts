...

  {
    ...
    events: [
      ...
      },
      {
        ...
        description:
          "Clean Architecture em 5 camadas (Domain → Application → Infrastructure → Contracts → API). 14 controllers, 10 Quartz jobs, DbContext unificado, SOAP Adapter CoreWCF, 58 docs. IA utilizada como par de programação na geração de código, revisão e refatoração.",
        category: "impl",
        badges: [BADGE_DOTNET, BADGE_AI],
        metrics: ["215 tasks", "250 arquivos C#", "58 docs", "14 controllers", "10 Quartz jobs"],
      },
      {
        id: "ev-tests",
        title: "191 testes — 100% passando",
        description:
          "183 testes unitários (xUnit + FluentAssertions + NSubstitute) e 8 testes de integração com Testcontainers + Azure SQL Edge. Cobertura Domain + Application > 80%. Comparado ao legado: 906 classes Java com 0 testes.",
        category: "validation",
        badges: [],
        metrics: ["191 testes", "100% passando", ">80% cobertura", "vs. 0 testes no legado"],
      },
    ],
  },
    ...
    events: [
      {
        ...
        description:
          "191 testes passando no ambiente Docker local. 4 coleções Postman validadas: DBS-API, DBS-SOAP-Adapter, DBS-Admin-Full, DBS-Mass-Test. Endpoints Payment + Admin cobertos. SOAP Adapter validado contra o WSDL original.",
        category: "validation",
        badges: [],
        metrics: ["191 testes", "4 coleções Postman", "SOAP + REST validados"],
      },
      {
        id: "ev-ready",
        title: "10 dias: de zero documentação a sistema cloud-native",
        description:
          "Engenharia reversa completa, 16 docs AS-IS construídos, dois caminhos TO-BE projetados, decisão tomada, sistema implementado. De 9 CVEs críticos e 0 testes a 191 testes, Clean Architecture, Okta, PCI DSS e IaC Bicep. Próximo: deploy Azure Container Apps.",
        category: "impl",
        badges: [BADGE_DOTNET, BADGE_AZURE, BADGE_OKTA],
        metrics: ["383 tipos C# (vs. 906 classes Java)", "0 CVEs críticos", "191 testes", "IaC Bicep pronto"],
      },
    ],
  },
];
